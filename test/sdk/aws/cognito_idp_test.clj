...
(def login-request
  {:body    "{\"Username\":\"PingFederate_robert.pofuk@rbinternational.com\",\"UserPoolId\":\"eu-west-1_Btgyjpp8Q\"}"
   :headers {"Authorization"        "AWS4-HMAC-SHA256 Credential=test-key-id/20200504/eu-central-1/cognito-idp/aws4_request, SignedHeaders=content-type;host;x-amz-date;x-amz-target, Signature=eb2290b526bf9ad811010e8a9e5661226b44a9bf15435218be153b2f44608810"
...
(def user-groups-request
  {:body    "{\"Username\":\"PingFederate_robert.pofuk@rbinternational.com\",\"UserPoolId\":\"eu-west-1_Btgyjpp8Q\",\"Limit\":60}"
   :headers {"Authorization"        "AWS4-HMAC-SHA256 Credential=test-key-id/20200504/eu-central-1/cognito-idp/aws4_request, SignedHeaders=content-type;host;x-amz-date;x-amz-target, Signature=7ba55a684f08d1b11d59e86ee60a8d84931018469ba87fc05bf4d6fb1a0443f4"
             "Content-Type"         "application/x-amz-json-1.1"
             "X-Amz-Date"           "20200504T080055Z"
             "X-Amz-Security-Token" "session-token"
